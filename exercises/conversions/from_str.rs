...
impl FromStr for Person {
    ...
    fn from_str(s: &str) -> Result<Person, Self::Err> {
        ...
        // Here I count the commas because I think that will be faster than
        // splitting the string twice.
        if s.matches(",").count() != 1 {
            return Err(ParsePersonError::BadLen);
        }
        // Now I can safely assume that there are exactly two parts in the split
        // string
        ...
        // This has now become a simple if statement; no need for a match.
        if name.len() == 0 {
        ...
        // I use `map_err` to convert any raw ParseIntError into a
